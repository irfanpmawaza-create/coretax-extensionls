...
- Status lisensi kode sumber (Bagian 8): **tetap proprietary**, tidak ditambahkan berkas `LICENSE` open source (mis. MIT) — sesuai default hukum hak cipta ("all rights reserved") dan konsisten dengan larangan menyalin/mendistribusikan ulang tanpa izin tertulis pada Bagian 8. Lisensi pustaka pihak ketiga yang di-vendor (PDF.js, SheetJS) tetap berlaku terpisah sesuai lisensinya masing-masing.
...
5. Saluran distribusi resmi (Chrome Web Store vs. distribusi manual "Load unpacked") belum dikonfirmasi — memengaruhi Bagian 15 tentang cara pembaruan diumumkan.
6. Belum ditentukan apakah fitur gratis yang sudah ada berpotensi dipindah ke tier berbayar nanti, atau hanya fitur baru yang akan berbayar (lihat Bagian 7).
